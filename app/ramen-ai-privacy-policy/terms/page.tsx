...
export default function RamenAITermsPage() {
  return (
    <RamenAILegalShell title="Terms of Service" description="These terms govern your use of the Ramen AI app.">
      <p>
      ...
      <h2>1. Acceptance</h2>
      <p>
        By using Ramen AI, you agree to these Terms of Service and our{" "}
        <Link href="/ramen-ai-privacy-policy">Privacy Policy</Link>. If you do not agree, do not use the app.
      </p>
      ...
      <p>
        Ramen AI may allow likes, comments, profile display names, profile avatars, and other user interactions. You are
      ...
      <p>
        Ramen AI may offer paid subscriptions through Google Play. Subscription pricing, billing periods, renewals,
        ...
        <Link href="/ramen-ai-privacy-policy/subscription-cancellation">Subscription Cancellation Help</Link> page for
        more information.
      </p>
      ...
      <p>
        We may update, modify, suspend, or discontinue parts of Ramen AI at any time. We are not responsible for
        interruptions caused by network issues, third-party services, device issues, or events outside our control.
      </p>

      <h2>7. Intellectual Property</h2>
      <p>
        Ramen AI, including its design, features, branding, and software, is protected by intellectual property laws.
      ...
      <h2>9. Disclaimers</h2>
      <p>
        Ramen AI is provided on an “as is” and “as available” basis. To the maximum extent permitted by law, we disclaim
