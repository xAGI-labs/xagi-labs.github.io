...
export default function Header() {
  ...
  return (
    <header
      className="sticky top-0 z-50 w-full border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-sm"
      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <Link href="/ai-tools" className="text-sm font-medium hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
              AI Tools
            </Link>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-[#0a0a0a]">
          <nav className="container mx-auto px-4 py-4 flex flex-col space-y-4">
            <Link href="/ai-tools" className="text-sm font-medium" onClick={() => setMobileMenuOpen(false)}>
              AI Tools
            </Link>
