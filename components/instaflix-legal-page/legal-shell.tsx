...
const legalLinks = [
  { href: "/instaflix-privacy-policy", label: "Privacy Policy" },
  { href: "/instaflix-privacy-policy/account-deletion", label: "Account Deletion" },
  { href: "/instaflix-privacy-policy/support", label: "Support" },
  { href: "/instaflix-privacy-policy/terms", label: "Terms" },
  { href: "/instaflix-privacy-policy/subscription-cancellation", label: "Subscription Help" },
]
...
export default function InstaFlixLegalShell({ title, description, children }: LegalShellProps) {
  return (
